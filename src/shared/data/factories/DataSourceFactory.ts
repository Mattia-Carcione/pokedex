...
import { BlobDataSource } from "../datasources/BlobDataSource";
...
import { BlobMockDataSource } from "../datasources/mock/BlobMockDataSource";
...
export class DataSourceFactory {
    ...
    public static create(env: EnvironmentEnum, deps: { httpClient: IHttpClient, httpMapper: IHttpErrorMapper, logger: ILogger }): IDataSource<Blob> {
        return FactoryHelper.createByEnvHelper<IDataSource<Blob>>(env, () => new BlobDataSource(deps.httpClient, deps.httpMapper, deps.logger), () => new BlobMockDataSource());
    }
}